var OverlayMenu = React.createClass({
  ...
  componentWillMount: function() {
    ...
    $("#site-menu").on("click", function(){ self.toggle(); });
  },
  ...
  render:function(){
    ...
    return(
      <div className="globalmenu" style={style}>
        ...
        <ul className="globalmenu-links">
          <li><a href="/#case-studies">Case Studies</a></li>
          <li><a href="/p/about">What We Do</a></li>
          <li><a href="https://medium.com/adjust-creative">Our Writings</a></li>
        </ul>
      </div>
